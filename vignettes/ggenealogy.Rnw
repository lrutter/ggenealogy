...
This vignette briefly introduced some of the capabilities of the \pkg{ggenealogy} package. Inevitably, new approaches will necessitate new features in subsequent versions and might reveal unforeseen bugs. Please post comments, suggestions, questions, and bug reports as an issue on the ggenealogy GitHub website \url{https://github.com/lindsayrutter/ggenealogy}.
